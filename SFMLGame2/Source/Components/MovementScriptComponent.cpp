...
#include "..\Systems\LuaStateManager.h"
#include "..\Entity.h"
...
LuaPlus::LuaObject MovementScriptComponent::GetPos(void)
{
	...
	if (CheckConvertAndCastPtr<IComponent, TransformComponent>(m_owner->GetComponent(GetIDFromName(TransformComponent::COMPONENT_NAME)), pTransformComponent))
